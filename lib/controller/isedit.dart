...
class UserFormised extends StatefulWidget {
  final bool? isedit;
  final String? userid;
  const UserFormised({super.key, this.isedit, this.userid});

  @override
  State<UserFormised> createState() => _UserFormisedState();
}

class _UserFormisedState extends State<UserFormised> {
    ...
    try {
      ...
      if (docSnapshot.exists) {
        ...
        setState(() {
          ...
          _birthController.text = data['dateOfBirth'] ?? '';
          ...
          _congregationController.text = data['congregation'] ?? '';
          _usernameController.text = data['username'] ?? '';
          _passwordController.text =
              data['password'] ?? ''; // Might want to handle password securely
          _role = data['role'] ?? 'Member';
          _isBaptised = data['isBaptised'] ?? false;
          _gender = data['gender'] ?? 'Male';
          _maritalStatus = data['maritalStatus'] ?? 'Single';
